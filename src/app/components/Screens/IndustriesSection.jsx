...
import Card1 from "../../../../public/Industry1.png"
import Card2 from "../../../../public/Industry2.png"
import Card3 from "../../../../public/Industry3.png"
import Card4 from "../../../../public/Industry7.png"
import Card5 from "../../../../public/Industry5.png"
import Card6 from "../../../../public/Industry6.png"
          ...
          <div key={index} className="group perspective w-72 h-48">
            <div className="relative preserve-3d group-hover:rotate-y-180 w-full h-full duration-1000">
              <div className="absolute backface-hidden w-full h-full flex justify-center items-center bg-white shadow-xl p-4 border rounded-lg">
                <Image src={industry.image} alt={industry.name} className="w-full h-full object-cover" />
              </div>
