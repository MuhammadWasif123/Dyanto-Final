...
import FooterIcon from "../../FooterItems/FooterIcon"
import {Icons} from "../../FooterItems/FooterData"
      ...
      >
        ...
        <div className="flex items-center justify-center gap-x-4 ">
              {sociallinks?.map((val,i)=>(
               <Image key={i} src={val.icon} alt="Error Loading Image" className="w-5 h-5 cursor-pointer" />
